...
import data from "../../../src/data/introduction.json";
...
const Introduction = () => {
    ...
    return (
        <div className="introduction">
            <h1 className="purpose heading capital">why co wallet</h1>
            <p className="desc capital">Embrace the Future of Contractor Management</p>
            <div className="cards">
                {data.features.map((card) => (
                    <Card text={card.text} img={card.image}/>
                ))}
            </div>
        </div>
    );
